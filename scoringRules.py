...
def crps(y, params, family, return_single_scores=False):
    """
    ...
    y : array, shape(n_examples,)
        True values.
    params : dictionary
        A dictionary of parameters for the specified distribution family.
        E.g. for Gaussian distribution, params should contain two arrays named 
        "mean" and "sd" of the same shape as y. For more infos see the scoringRules
        docs.
        
    family : string
        Distribution family used to calculate the score.
    return_single_scores : bool, optional
        Return score for single examples. The default is False.
    ...
    for key, value in params.items():
        kwargs[key] =  convert_to_Rtype(value)
    scores = scoringRules.crps(y=convert_to_Rtype(y), family=family, **kwargs)
